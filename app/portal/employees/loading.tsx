    ...
    <div className="animate-pulse">
      ...
      <div className="flex items-start justify-between gap-4 mb-6">
        <div>
          ...
          <div className="h-4 w-64 bg-gray-100 dark:bg-gray-800/60 rounded-xs" />
        </div>
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="h-3 bg-gray-100 dark:bg-gray-800 rounded-xs" />
              <div className="h-3 bg-gray-100 dark:bg-gray-800 rounded-xs" />
              <div className="col-span-2 h-3 bg-gray-100 dark:bg-gray-800 rounded-xs" />
            </div>
          </div>
        ))}
      </div>
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          <div className="flex gap-4 px-5 py-3 bg-gray-50 dark:bg-gray-800/60">
            {[150, 120, 120, 110, 70].map((w, i) => (
              <div key={i} className="h-4 bg-gray-200 dark:bg-gray-700 rounded-xs" style={{ width: w }} />
            ))}
          </div>
          {/* Rows */}
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="flex gap-4 px-5 py-3.5">
              <div className="space-y-1" style={{ width: 150 }}>
                <div className="h-4 w-36 bg-gray-200 dark:bg-gray-700 rounded-xs" />
                <div className="h-3 w-20 bg-gray-100 dark:bg-gray-800 rounded-xs" />
              </div>
              <div className="h-4 bg-gray-100 dark:bg-gray-800 rounded-xs" style={{ width: 120 }} />
              <div className="h-4 bg-gray-100 dark:bg-gray-800 rounded-xs" style={{ width: 120 }} />
              <div className="h-4 bg-gray-100 dark:bg-gray-800 rounded-xs" style={{ width: 110 }} />
